...
class Adjoint_Source:
    ...
    def __init__(self, adjoint_simulation, forward_simulation, function, frequency=1.0, center=Vector3(), size=Vector3(), dim=Vector3(), functionals=[], udfs=[]):
        ...
        # function is the real time source function used to generate sources at other points by shifting and multiplying
        # example of udfs udf[0] = (['Ex', 'Ey', 'Ez'], a function that returns conjugate of partial f / partial Ex, Ey, Ez)
        # an objective function that takes the specified component and spits out a real number
