...
k0 = omega
eta0 = 1
material = ffip.FePt(frequency=ft)
...
sim.run(
    stop_condition=ffip.run_until_time(src_func.end_time * 5), 
    np=2
    # skip=True,
    # pop=True
)
...
#%% read fields
fex = ex_dft.get_interpolant()
fey = ey_dft.get_interpolant()
fez = ez_dft.get_interpolant()
